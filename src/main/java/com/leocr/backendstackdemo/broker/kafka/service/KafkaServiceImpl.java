package com.leocr.backendstackdemo.broker.kafka.service;
...
import com.leocr.backendstackdemo.persistence.redis.repo.RedisMessageRepository;
...
@Transactional
public class KafkaServiceImpl implements BrokerService {
